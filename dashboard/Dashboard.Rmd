...
map_recope <- leaflet(width = "100%")%>%
        ...
        "color" = "white", "background" = "#FE634E"))) %>% 
                  ...
                  addControl(html = c("<img src='https://image.flaticon.com/icons/svg/316/316377.svg' height=18 width=18>Gasolineras<br/>", 
                                      "<img src='https://image.flaticon.com/icons/svg/316/316372.svg' height=18 width=18>Planteles<br/>"), position="bottomright")

#Tabla-----

dt_recope <- datatable(shared_gas, extensions="Scroller", style="bootstrap", class="compact", width="100%",
