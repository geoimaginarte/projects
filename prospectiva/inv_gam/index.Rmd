...
comer <- st_read(conn, layer="comercials_point", query="select fid, fid as id, Nombre, Categorias, shop, st_x(geom) as x, st_y(geom) as y, geom from comercials_point where shop = 'mall'")
...
#Mapa de restaurantes con densidades de los otros subsectores----

lat_rd = st_coordinates(resid_inv)[,2]
lon_rd = st_coordinates(resid_inv)[,1]

rd = kde2d(lon_rd,lat_rd,h=.2,n=1000)
rd_den <- raster(rd)
...
### Mapa de Densidad de Residenciales por Area
