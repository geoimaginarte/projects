...
inv_r <- read_excel("E:/Trabajos Fran/Prospectiva investigación de mercado/InventarioGAM/Datos/DATASET_ENINVENTARIO.xlsx", sheet = "Residenciales", range = cell_cols("A:AH"))
inv_r[2:4] <- list(NULL)
inv_r[3:8] <- list(NULL)
inv_r[5:6] <- list(NULL)
inv_r[23] <- NULL

inv_i <- read_excel("E:/Trabajos Fran/Prospectiva investigación de mercado/InventarioGAM/Datos/DATASET_ENINVENTARIO.xlsx", sheet = "Industrial", range = "D1:G383")
inv_i$Cantidad_personas <- as.integer(inv_i$Cantidad_personas)

inv_o <- read_excel("E:/Trabajos Fran/Prospectiva investigación de mercado/InventarioGAM/Datos/DATASET_ENINVENTARIO.xlsx", sheet = "Oficentros", range = "C1:G280")
...
bins_resid <- c(10, 15, Inf)
pal_resid <- colorBin(c("navy", "red"), domain = shared_resid$data()$FECHA, bins = bins_resid)

bins_indust <- c(10, 15, Inf)
pal_indust <- colorBin(c("navy", "red"), domain = shared_indust$data()$Fecha, bins = bins_indust)

bins_ofic <- c(10, 15, 20, Inf)
pal_ofic <- colorBin(c("navy", "red", "green"), domain = shared_ofic$data()$Fecha_inicio, bins = bins_ofic)

bins_comer <- c(10, 15, Inf)
pal_comer <- colorBin(c("navy", "red"), domain = shared_comer$data()$Fecha, bins = bins_comer)
...
resipop <- paste0("<b>Nombre:</b> ", shared_resid$data()$Nombre, "<br><b>Distrito:</b> ", shared_resid$data()$distrito,  "<br><b>Conurbano:</b> ", shared_resid$data()$Conurbanos)
...
map_resid <- leaflet(width = "100%")%>%
                  ...
                  addCircleMarkers(data = shared_resid, group = "Z.R rango fechas", color = ~pal_resid(FECHA), radius = 7, stroke = FALSE, fillOpacity = 0.5) %>% 
                  ...
                  addLayersControl(position = "topleft",
                      ...
                      overlayGroups = c( "Z. Residenciales", "Z.R rango fechas","Limites de residenciales","Distritos GAM", "Cornubanos GAM", 'Nuevo Dibujo'),
                      options = layersControlOptions(collapsed = FALSE))%>%
                  hideGroup(c("Z.R rango fechas","Limites de residenciales")) %>% 
                  ...
                  addLegend(pal = pal_resid, values = shared_resid$data()$FECHA, opacity = 1, title = "Z.R rango fechas")
...
map_indust <- leaflet(width = "100%")%>%
                  ...
                  addCircleMarkers(data = shared_indust, group = "Z.I rango fechas", color = ~pal_indust(Fecha), radius = 7, stroke = FALSE, fillOpacity = 0.5) %>%
                  addMarkers(data= shared_indust, group = "Z. Industriales", label = ~Nombre, icon = indicon, popup = indupop)%>% 
                  addLayersControl(position = "topleft",
                      baseGroups = c("OSM", "Calles en oscuro", "Satelite"),
                      overlayGroups = c("Z. Industriales", "Z.I rango fechas", "Limites de Z.Industriales", "Z.I. Planes Reguladores", "Z.I. PlanGAM 2013", "Distritos GAM", "Conurbanos GAM", 'Nuevo Dibujo'),
                      options = layersControlOptions(collapsed = FALSE))%>%
                  hideGroup(c("Z.I rango fechas", "Limites de Z.Industriales", "Z.I. Planes Reguladores", "Z.I. PlanGAM 2013")) %>% 
                  addEasyprint(options = easyprintOptions(
                    title = 'Print map',
                    position = 'bottomleft',
                    sizeModes = list("A4Landscape", "Current"),
                  ...
                  addDrawToolbar(
                    ...
                    circleMarkerOptions = FALSE,
                    editOptions = editToolbarOptions(selectedPathOptions = selectedPathOptions()))%>%
                  addLegend(pal = pal_indust, values = shared_indust$data()$Fecha, opacity = 1, title = "Z.I rango fechas")
...
map_ofic <- leaflet(width = "100%")%>%
                  ...
                  addPolygons(data=conur, group="Conurbanos GAM", color = "#0F9D58", popup= conurpop, fillOpacity = 0.05)%>%   
                  addPolygons(data=dist, group="Distritos GAM", color = "#698eff", popup= distpop, fillOpacity = 0.05)%>%
                  addCircleMarkers(data = shared_ofic, group = "Oficentros rango fechas", color = ~pal_ofic(Fecha_inicio), radius = 7, stroke = FALSE, fillOpacity = 0.5) %>%
                  addMarkers(data= shared_ofic, group = "Oficentros", label = ~Nombre, icon = oficon, popup = ofipop)%>% 
                  addLayersControl(position = "topleft",
                      baseGroups = c("OSM", "Calles en oscuro", "Satelite"),
                      overlayGroups = c( "Oficentros", "Oficentros rango fechas","Distritos GAM", "Conurbanos GAM", 'Nuevo Dibujo'),
                      options = layersControlOptions(collapsed = FALSE))%>%
                  hideGroup("Oficentros rango fechas") %>% 
                  addEasyprint(options = easyprintOptions(
                    title = 'Print map',
                    position = 'bottomleft',
                    sizeModes = list("A4Landscape", "Current"),
                  ...
                  addDrawToolbar(
                    ...
                    circleMarkerOptions = FALSE,
                    editOptions = editToolbarOptions(selectedPathOptions = selectedPathOptions()))%>%
                  addLegend(pal = pal_ofic, values = shared_ofic$data()$Fecha_inicio, opacity = 1, title = "Oficentros rango fechas")
...
map_comer <- leaflet(width = "100%")%>%
                  ...
                  addPolygons(data=conur, group="Conurbanos GAM", color = "#0F9D58", popup= conurpop, fillOpacity = 0.05)%>%  
                  addPolygons(data=dist, group="Distritos GAM", color = "#698eff", popup= distpop, fillOpacity = 0.05)%>%
                  addCircleMarkers(data = shared_comer, group = "Comercial rango fechas", color = ~pal_comer(Fecha), radius = 7, stroke = FALSE, fillOpacity = 0.5) %>%  
                  addMarkers(data= shared_comer, group = "Comerciales", label = ~Nombre, icon = comercon, popup = comerpop)%>% 
                  addLayersControl(position = "topleft",
                      baseGroups = c("OSM", "Calles en oscuro", "Satelite"),
                      overlayGroups = c( "Comerciales", "Comercial rango fechas","Distritos GAM", "Conurbanos GAM", "Nuevo Dibujo"),
                      options = layersControlOptions(collapsed = FALSE))%>%
                  hideGroup("Comercial rango fechas") %>%  
                  addEasyprint(options = easyprintOptions(
                    title = 'Print map',
                    position = 'bottomleft',
                    sizeModes = list("A4Landscape", "Current"),
                  ...
                  addDrawToolbar(
                    ...
                    circleMarkerOptions = FALSE,
                    editOptions = editToolbarOptions(selectedPathOptions = selectedPathOptions()))%>%
                  addLegend(pal = pal_comer, values = shared_comer$data()$Fecha, opacity = 1, title = "Comercial rango fechas")
...
map_rest <- leaflet(width = "100%")%>%
                  ...
                  addMarkers(data= shared_rest, group = "Restaurantes", label = ~Nombre, popup = restpop,icon = ~resticons[Cadena])%>% 
                  addLayersControl(position = "topleft",
                      baseGroups = c("OSM", "Calles en oscuro", "Satelite"),
