...
resid_rango <- icons(
  iconUrl = ifelse(shared_resid$data()$FECHA < 15,
    "bydate/house_10.png", "bydate/house_15.png"
  ))

indust_rango <- icons(
  iconUrl = ifelse(shared_indust$data()$Fecha < 15,
    "bydate/indust_10.png", "bydate/indust_15.png"
  ))

ofic_rango <- icons(
  iconUrl = ifelse(shared_ofic$data()$Fecha_inicio < 15,
    "bydate/ofic_10.png", ifelse(shared_ofic$data()$Fecha_inicio < 20, "bydate/ofic_15.png", "bydate/ofic_20.png"
  )))

comer_rango <- icons(
  iconUrl = ifelse(shared_comer$data()$Fecha < 15,
    "bydate/comer_10.png", "bydate/comer_15.png"
  ))
...
map_resid <- leaflet(width = "100%")%>%
                  ...
                  addMarkers(data= shared_resid, group = "Z. Residenciales", label = ~Nombre, icon = ~resid_rango[FECHA], popup = resipop)%>% 
...
map_indust <- leaflet(width = "100%")%>%
                  ...
                  addMarkers(data= shared_indust, group = "Z. Industriales", label = ~Nombre, icon = ~indust_rango[Fecha], popup = indupop)%>% 
                  addLayersControl(position = "topleft",
                      baseGroups = c("OSM", "Calles en oscuro", "Satelite"),
...
map_ofic <- leaflet(width = "100%")%>%
                  ...
                  addPolygons(data=conur, group="Conurbanos GAM", color = "#0F9D58", popup= conurpop, fillOpacity = 0.05)%>%   
                  addPolygons(data=dist, group="Distritos GAM", color = "#698eff", popup= distpop, fillOpacity = 0.05)%>%
                  addMarkers(data= shared_ofic, group = "Oficentros", label = ~Nombre, icon = ~ofic_rango[Fecha_inicio], popup = ofipop)%>% 
                  addLayersControl(position = "topleft",
                      baseGroups = c("OSM", "Calles en oscuro", "Satelite"),
...
map_comer <- leaflet(width = "100%")%>%
                  ...
                  addPolygons(data=conur, group="Conurbanos GAM", color = "#0F9D58", popup= conurpop, fillOpacity = 0.05)%>%  
                  addPolygons(data=dist, group="Distritos GAM", color = "#698eff", popup= distpop, fillOpacity = 0.05)%>%
                  addMarkers(data= shared_comer, group = "Comerciales", label = ~Nombre, icon = ~comer_rango[Fecha], popup = comerpop)%>% 
                  addLayersControl(position = "topleft",
                      baseGroups = c("OSM", "Calles en oscuro", "Satelite"),
