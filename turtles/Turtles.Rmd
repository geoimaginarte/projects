...
Chart <- highchart(type = "stock") %>% 
  ...
  hc_add_series(turtle.date[,1],  yAxis = 0, type = "column", 
                pointInterval= 30*24*3600*1000, 
                name="Egg Laying Females", color = "#2F528F")%>%
  hc_add_series(turtle.date[,2],  yAxis = 1, type = "spline", 
                pointInterval= 30*24*3600*1000, 
                name="Percentage of Nests Harvested", color = "#ED7D31")%>%
